 ...
 * @author sofia
 */
@WebServlet("/Admin/Usuarios/listar")
public class ListarUsuariosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            if (usuario == null || !"admin_sistema".equalsIgnoreCase(usuario.getRol())) {
                resp.sendRedirect(req.getContextPath() + "/login.jsp?error=Acceso+denegado");
                return;
            }
