...
public class ReporteGananciasServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ReporteGananciasServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ReporteGananciasServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            List<ReporteGanancias> reporte = reporteDB.gananciasPorIntervalo(inicio, fin, institucionId);

            req.setAttribute("reporte", reporte);
            req.getRequestDispatcher("/Reportes/ganancias.jsp").forward(req, resp);
        } catch (Exception e) {
